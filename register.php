...
if(isset($_POST["register"]))
{
  ...
  if($statement->execute($check_data)) 
  {
    ...
    else
    {
      if(empty($username))
      {
        $message .= '<p><label>Username / Password is required</label></p>';
      }
      if(empty($password))
      {
        $message .= '<p><label>Username / Password is required</label></p>';
...
<html>  
    <head>  
      <title>My Chatting Application</title> 
        <style>
        body,html{
    ...
    <body >  
      <div class="container">
        <br />
        <h3 align="center"><font color="white">Registration Here</font></a></h3><br />
        <div id="kanan">
